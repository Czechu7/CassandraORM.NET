...
namespace CassandraOrm.MaterializedViews;
...
public class MaterializedViewAttribute : Attribute
{
    ...
    public string BaseTable { get; }
    public string? Keyspace { get; set; }

    public MaterializedViewAttribute(string viewName, string baseTable)
    {
...
/// </summary>
[AttributeUsage(AttributeTargets.Class)]
public class MaterializedViewWhereAttribute : Attribute
{
    public string WhereClause { get; }

    public MaterializedViewWhereAttribute(string whereClause)
    {
...
public class MaterializedViewBuilder
{
    ...
    public MaterializedViewBuilder(string viewName, string baseTable)
    {
...
public class MaterializedViewRegistry
{
    ...
    {
        return _viewMetadataCache.TryGetValue(viewType, out var metadata) ? metadata : null;
    }
    ...
    {
        return _viewMetadataCache.ContainsKey(type);
    }
    ...
    {
        return _viewMetadataCache.Keys;
    }
...
public class MaterializedViewManager
{
    ...
    public MaterializedViewManager(MaterializedViewRegistry registry, Cassandra.ISession session)
    {
    ...
    public async Task CreateViewAsync(Type viewType)
    {
        ...
        await _session.ExecuteAsync(new Cassandra.SimpleStatement(createCql));
    }
    ...
    public async Task DropViewAsync(Type viewType)
    {
        ...
        await _session.ExecuteAsync(new Cassandra.SimpleStatement(dropCql));
    }
