...
public class CassandraMetrics
{
    ...
    public CassandraMetrics(ILogger? logger = null)
    {
        _logger = logger;
    }
    ...
    public void RecordOperation(string operationType, string tableName, TimeSpan duration, bool success, string? error = null)
    {
        ...
        {
            _logger?.LogWarning("Slow operation detected: {Operation} on {Table} took {Duration}ms", 
    ...
    public void Reset()
    {
        ...
        _logger?.LogInformation("Cassandra metrics have been reset");
    }
    ...
    public void LogSummary()
    {
        ...
        if (summary.SlowestOperations.Any())
        {
            ...
            _logger?.LogInformation("Slowest recent operation: {Operation} on {Table} ({Duration}ms)",
...
public class OperationMetrics
{
    ...
    public OperationMetrics(string operationType, string tableName)
    {
        OperationType = operationType;
        TableName = tableName;
    }
...
public class OperationTimer : IDisposable
{
    ...
    private readonly CassandraMetrics _metrics;
    private readonly string _operationType;
    private readonly string _tableName;
    private bool _success = true;
    private string? _error;

    public OperationTimer(CassandraMetrics metrics, string operationType, string tableName)
    {
        _metrics = metrics;
    ...
    {
        _stopwatch.Stop();
        _metrics.RecordOperation(_operationType, _tableName, _stopwatch.Elapsed, _success, _error);
    }
}
